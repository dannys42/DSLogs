...
// DSLogs
#define COCOAPODS_POD_AVAILABLE_DSLogs
#define COCOAPODS_VERSION_MAJOR_DSLogs 0
#define COCOAPODS_VERSION_MINOR_DSLogs 1
#define COCOAPODS_VERSION_PATCH_DSLogs 0
